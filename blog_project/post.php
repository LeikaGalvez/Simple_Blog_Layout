	...
	<body style="background-color: silver">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2"> 
				<div id="post">
					<h1><a href="#">My Topic</a></h1></br>
					<p>April 28, 2024</p>
					<p class="lead">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem 
					...
					<img src="images/header.jpg" class="img-thumbnail">
